...
<div class="top-nav header">
    <div class="container">
        ...
        <div class="top-lead hidden-xs hidden-sm">
            ...
            <a href="https://apps.apple.com/vn/app/greencoffee/id1254356638" style="float: right;margin: 0px 10px 0px 0px;" class="logo-cp"><img style="width: 100px;height: 35px;" src="<?= Yii::$app->getUrlManager()->getBaseUrl() ?>/img/app-store.png"></a>
        </div>
