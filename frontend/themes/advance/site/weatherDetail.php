        ...
        <div class="right-content1">
            <ul>
                ...
                <li>
                    ...
                    <a href="<?= \yii\helpers\Url::toRoute(['site/detail','temp'=>floor(($weather->tmax + $weather->tmin) / 2),'pre'=>$weather->precipitation,'wind'=>$weather->wndspd,'station_id'=>$weather->station_id]) ?>">Khuyến cáo</a>
                </li>
            </ul>
        </div>
    </div>
