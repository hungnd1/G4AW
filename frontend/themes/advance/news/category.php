        ...
        <div class="container">
            <div class="left-content">
                <div class="cr-page-link">
                    ...
                    <span>/</span>
                    <a href="<?= Url::toRoute(['news/index']) ?>">Danh sách cây trồng</a>
                </div>
                <div class="m-content">
                    <div class="list-news-block">
                        <div class="tab-ct">
                            <div class="tab-content">
                                <?php if (isset($lstFruit) && !empty($lstFruit)) {
                                    $i = 1;
                                    foreach ($lstFruit as $item) {
                                        /** @var $item \common\models\Fruit */
                                        ?>
                                        <div class="list-new-1">
                                            <div class="thumb-common">
                                                <img class="blank-img" src="../img/blank.gif">
                                                <a href="<?= Url::toRoute(['news/detail-fruit', 'id' => $item->id]) ?>"><img
                                                            class="thumb-cm" src="<?= $item->getImageLink() ?>"></a>
                                            </div>
                                            <div class="left-list">
                                                <h3>
                                                    <a href="<?= Url::toRoute(['news/detail-fruit', 'id' => $item->id]) ?>"><?= $item->name ?></a>
                                                </h3>
                                            </div>
                                        </div>
                                        <?php
